...
BEGIN
    ...
    /*
     * Obtain the authenticated user from the PostgreSQL
     * session variable.
     *
     * If the variable does not exist or is empty,
     * the operation is considered anonymous.
     */
    BEGIN
    ...
    ELSIF TG_OP = 'UPDATE' THEN
        ...
        /*
         * Analysis uses logical deletion.
         *
         * When is_deleted changes from FALSE to TRUE,
         * register the operation as DELETE in the audit log.
         */
        IF (
